Ext.define("Administrator.Components.CategoryTree", {
	...
	loadCategories: function () {
		var call = new Administrator.Util.ServiceCall(this.categoryService, "getAllCategories");
		call.setLoadMessage("Loading categories...");
