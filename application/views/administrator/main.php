...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="frontend/administrator/css/partkeepr-theme.css"/>
		<link rel="stylesheet" type="text/css" href="frontend/administrator/js/Ext.ux/statusbar/css/statusbar.css"/>
		<link rel="stylesheet" type="text/css" href="frontend/administrator/css/PartKeepr.css"/>
		...
		<script type="text/javascript" src="frontend/administrator/js/partkeepr.js"></script>
		...
		<script type="text/javascript" src="frontend/administrator/js/webcam.js"></script>
	</head>
<body>
